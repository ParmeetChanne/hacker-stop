...
const Hacking = () => {
  return (
    <div className="Hacking" id='links'>
      <h1>Hacking Resources for Beginners</h1>
      <br></br>
      <br></br>
      <div>
        <h2>Video Courses</h2>
        <br></br>
        <ul>
          <li><a href="https://academy.tcm-sec.com/p/practical-ethical-hacking-the-complete-course">10 Hours of Practical Ethical Hacking by The Cyber Mentor</a></li>
          <li><a href="https://youtu.be/WnN6dbos5u8">Full Ethical Hacking Course - Beginner Network Penetration Testing</a></li>
          <li><a href="https://www.youtube.com/watch?v=24fHLWXGS-M&ab_channel=TheCyberMentor">Beginner web application hacking</a></li>
          <li><a href="https://www.youtube.com/watch?v=2_lswM1S264&ab_channel=freeCodeCamp.org">Small hacking course by Hackersploit</a></li>
          <li><a href="https://www.youtube.com/playlist?list=PLBf0hzazHTGOEuhPQSnq-Ej8jRyXxfYvl">130+ videos on Beginner Ethical Hacking by Hackersploit</a></li>
          <li><a href="https://www.youtube.com/watch?v=dz7Ntp7KQGA&ab_channel=edureka%21">Ethical Hacking Course by Edureka</a></li>
          <li><a href="https://www.hacker101.com/videos">Hacker101 Videos </a></li>
          <li><a href="https://www.cybrary.it/">Website Containing Various Hacking Courses</a></li>
          <li><a href="https://youtu.be/2TofunAI6fU">Secret Guide to hacking</a></li>
          <li style={{ color: 'white' }}>For Detailed Web Hacking Resources go <a href="/bugbounty" style={{ color: '#15cdfc' }}>here</a></li>
        </ul>
      </div>
      <br></br>
      <div>
        <h2>Articles and Repositories</h2>
        <br></br>
        <ul>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="https://dev.to/atan/what-is-ctf-and-how-to-get-started-3f04">All About CTF's</a></li>
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="https://www.kali.org/download-kali-linux-revealed-book/">Kali Linux revealed</a></li>
          <li><a href="https://www.amazon.com/Penetration-Testing-Hands-Introduction-Hacking/dp/B00SLUUIQW">Penetration Testing: A hands on Introduction to hacking</a></li>
      ...
      <br></br>
      <div>
        <h2>Follow News and Reports: </h2>
        <br></br>
        <ul>
          <li><a href="https://thehackernews.com/">TheHackerNews</a></li>
          <li><a href="https://portswigger.net/daily-swig/hacking-news">The Daily Swig</a></li>
